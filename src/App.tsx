...
const emptyProfile: Profile = { name:'', phone:'', email:'', school:'', major:'', degree:'' };
...
function ProfileView({ profile, setProfile }:{ profile:Profile; setProfile:(profile:Profile)=>void }) {
  const fields:[keyof Profile,string][]=[['name','姓名'],['phone','手机号'],['email','邮箱'],['school','学校'],['major','专业'],['degree','学历']];
